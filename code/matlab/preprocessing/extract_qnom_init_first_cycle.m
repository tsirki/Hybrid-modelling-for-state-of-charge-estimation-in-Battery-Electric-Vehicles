...
if exist('Q_all', 'var') ~= 1
    if exist('battery_workspace_core.mat', 'file') == 2
        load('battery_workspace_core.mat', 'Q_all');
    else
        error('Missing Q_all and battery_workspace_core.mat was not found.');
    end
end
...
fprintf('Saved Q_nom_init for %d/%d batteries to Q_nom_init_first_cycle_all_batteries.mat.\n', ...
    nnz(has_first_cycle), nB);
